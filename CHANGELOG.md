...
### Fixed
- Arrow-key escape sequences were echoed as `^[[B` because the main input
  loop ran with the terminal in canonical/echo mode; it now switches to raw
  no-echo input (restored on exit) and reads reliably from `/dev/tty`.
- Reduce screen flicker by repainting only the frame lines that changed
  when the frame height is unchanged, instead of rewriting the whole frame.
...
[Unreleased]: https://github.com/MickaelBlet/netrc-manager/compare/v0.0.4...HEAD
[0.0.4]: https://github.com/MickaelBlet/netrc-manager/compare/v0.0.3...v0.0.4
[0.0.3]: https://github.com/MickaelBlet/netrc-manager/compare/v0.0.2...v0.0.3
[0.0.2]: https://github.com/MickaelBlet/netrc-manager/compare/v0.0.1...v0.0.2
